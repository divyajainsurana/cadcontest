...
extern ABC_DLL Abc_Obj_t *        Abc_AigCXor( Abc_Aig_t * pMan, Abc_Obj_t * p0_1, Abc_Obj_t * p0_2, Abc_Obj_t * p1_1, Abc_Obj_t * p1_2 );
...
extern ABC_DLL void               Abc_NtkMiterAddOne( Abc_Ntk_t * pNtk, Abc_Ntk_t * pNtkMiter );
/*=== abcNames.c ====================================================*/
